...
(function($, undef) {
    ...
    function ellipsisElement($e, $d, $i, o, after) {
        ...
        var txt = getTextContent(e), space = txt.indexOf(" ") !== -1 ? " " : "ã€€", separator = o.wrap == "letter" ? "" : space, textArr = txt.split(separator), position = -1, midPos = -1, startPos = 0, endPos = textArr.length - 1;
